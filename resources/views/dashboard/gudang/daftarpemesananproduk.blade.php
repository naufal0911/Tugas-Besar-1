                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="event.preventDefault(); if (confirm('Anda yakin ingin menghapus?')) { document.getElementById('delete-form-{{ $item->id }}').submit(); }"><span class="badge bg-danger"><i class="bi bi-trash"></i></span></a>

                                            <!-- Form untuk delete -->
                                            <form id="delete-form-{{ $item->id }}" action="{{ URL('/Dashboard/destroy/pemesananproduk/'.$item->id )}}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
