            ...
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control mb-3" style="width: 17%" placeholder="<?php echo e($daftar->jadwal->tanggal_mulai_pkl); ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label for="tanggal_mulai_pkl">Tanggal Selesai PKL</label>
                      <input type="text" class="form-control mb-3" style="width: 17%" placeholder="<?php echo e($daftar->jadwal->tanggal_selesai_pkl); ?>" disabled>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control mb-3" style="width: 19%" placeholder="Sedang Dilaksanakan" disabled>
                    </div>
                    <?php elseif( $daftar->tanggal < $daftar->jadwal->tanggal_mulai_pkl ): ?>
                    <div class="form-group">
                      <label for="tanggal_mulai_pkl">Status PKL</label>
                      <input type="text" class="form-control mb-3" style="width: 19%" placeholder="Belum Dilaksanakan" disabled>
                    </div>
                    <?php elseif( $daftar->tanggal > $daftar->jadwal->tanggal_selesai_pkl ): ?>
                    <div class="form-group">
                      <label for="tanggal_mulai_pkl">Status PKL</label>
                      <input type="text" class="form-control mb-3" style="width: 19%" placeholder="Selesai Dilaksanakan" disabled>
                    </div>
                    <?php endif; ?>
                    <?php endif; ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\web\resources\views/dashboard/detail.blade.php ENDPATH**/ ?>