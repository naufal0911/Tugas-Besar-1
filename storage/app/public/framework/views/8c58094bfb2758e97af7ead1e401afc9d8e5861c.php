            ...
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control mb-3" style="width: 17%" name="tanggal_mulai_pkl">
                    </div>
                    <div class="form-group">
                        <label for="tanggal_mulai_pkl">Tanggal Selesai PKL</label>
                        <input type="date" class="form-control mb-3" style="width: 17%" name="tanggal_selesai_pkl">
                      </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sipkl/web/resources/views/dashboard/staff/buatjadwal.blade.php ENDPATH**/ ?>