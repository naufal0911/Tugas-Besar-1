                        ...
                        <main>
                          ...
                          <?php endif; ?>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input class="form-control mb-3" type="text"  placeholder="<?php echo e(auth()->user()->siswa->nis_siswa); ?>" disabled>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-3"  placeholder="<?php echo e(auth()->user()->siswa->alamat_rumah); ?>" disabled>
                                      </div>
                                      <div class="form-group">
                                        <label for="email_sekolah">Jurusan</label>
                                        <input type="text" class="form-control mb-3"  placeholder="<?php echo e(auth()->user()->siswa->jurusan); ?>" disabled>
                                      </div>
                                      <a class="btn btn-outline-primary" href=" <?php echo e(url('/Dashboard/profile/edit/' . auth()->user()->siswa->id)); ?> " role="button">Edit Profile</a>
                                      <a class="btn btn-outline-success"  href=" <?php echo e(url('/Dashboard/profile/editpassword/' . auth()->user()->id)); ?> " role="button">Edit Password</a>
                          </main>
        <?php $__env->stopSection(); ?>

<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Naufal\Documents\web\resources\views/dashboard/siswa/profile.blade.php ENDPATH**/ ?>