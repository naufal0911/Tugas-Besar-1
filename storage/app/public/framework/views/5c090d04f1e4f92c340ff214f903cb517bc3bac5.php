                        ...
                        <main>
                          ...
                          <?php endif; ?>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-3" style="width: 38%" placeholder="<?php echo e(auth()->user()->siswa->jurusan); ?>" disabled>
                                      </div>
                                      <div class="form-group">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\web\resources\views/dashboard/siswa/profile.blade.php ENDPATH**/ ?>