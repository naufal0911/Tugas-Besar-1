    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link <?php echo e(Request::is('Dashboard/admin/daftarsiswa') ? 'active' : ''); ?>" href="<?php echo e(url('/Dashboard/admin/daftarsiswa')); ?>">
                    <div class="sb-nav-link-icon"><i class="bi bi-people"></i></div>
                    Daftar Siswa
                </a>
...
<?php /**PATH C:\Users\Acer\Downloads\Compressed\web\resources\views/dashboard/layouts/dashboard.blade.php ENDPATH**/ ?>