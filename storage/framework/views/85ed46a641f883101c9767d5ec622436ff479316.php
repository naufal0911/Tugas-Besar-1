                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card text-white mb-4" style="background-color: #F7464A">
                                    ...
                                    <div class="small" style="margin-left: 13%"><?php echo e($siswa->count()); ?></div>
                                    </div>
                                </div>
                            </a>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card text-white mb-4" style="background-color: #46BFBD">
                                    <div class="card-body"><i class="bi bi-people" style="margin-right: 5%"></i>Data guru 
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Acer\Downloads\Compressed\web\resources\views/dashboard/index.blade.php ENDPATH**/ ?>