                            ...
                            <?php $no=1;?>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <a href="<?php echo e(URL('/Dashboard/toko/daftarpemesananproduk/detail/'.$item->id )); ?>"><span class="badge bg-primary" ><i class="bi bi-eye"></i></span></a>
                                  </td>
                                </tr>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ujicoba\web\resources\views/dashboard/toko/daftarpemesananproduk.blade.php ENDPATH**/ ?>