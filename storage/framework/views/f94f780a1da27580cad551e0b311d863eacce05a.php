    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            ...
            <a class="nav-link <?php echo e(Request::is('Dashboard/gudang/daftarpemesananproduk') ? 'active' : ''); ?>" href="<?php echo e(url('/Dashboard/gudang/daftarpemesananproduk')); ?>">
                ...
                <a class="nav-link collapsed <?php echo e(Request::is('Dashboard/master/daftaruser') ? 'active' : ''); ?> <?php echo e(Request::is('Dashboard/master/daftarproduk') ? 'active' : ''); ?>" href="#" data-bs-toggle="collapse" data-bs-target="#sss" aria-expanded="false" aria-controls="collapseLayouts">
                ...
                <div class="collapse" id="sss" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link <?php echo e(Request::is('Dashboard/master/daftaruser') ? 'active' : ''); ?>" href="<?php echo e(url('/Dashboard/master/daftaruser')); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-people"></i></div>
                            Data User
                        </a>
                        <a class="nav-link <?php echo e(Request::is('Dashboard/master/daftarproduk') ? 'active' : ''); ?>" href="<?php echo e(url('/Dashboard/master/daftarproduk')); ?>">
                ...
                <a class="nav-link collapsed <?php echo e(Request::is('Dashboard/daftarpemesananproduk') ? 'active' : ''); ?> <?php echo e(Request::is('Dashboard/toko/daftarpenjualanproduk') ? 'active' : ''); ?> <?php echo e(Request::is('Dashboard/toko/daftarpenjualan/detail*') ? 'active' : ''); ?>" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayoutsr" aria-expanded="false" aria-controls="collapseLayouts">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-shop"></i></div>
                    Toko
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapseLayoutsr" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link <?php echo e(Request::is('Dashboard/toko/daftarpenjualanproduk*') ? 'active' : ''); ?>" href="<?php echo e(url('/Dashboard/toko/daftarpenjualanproduk')); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-cart-check"></i></div>
                            Penjualan
                        </a>
                    </nav>
...
<?php /**PATH D:\ujicoba\web\resources\views/dashboard/layouts/dashboard.blade.php ENDPATH**/ ?>