                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php $no=1;?>
                              ...
                              <tbody>
                                <tr>
                                  <?php $__currentLoopData = $gudangpurchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <td><?php echo e($no++); ?></td>
                                  <td>No. <?php echo e($item->productID); ?></td>
                                  <td><?php echo e(\Carbon\Carbon::parse($item->datereceived)->isoFormat('D MMMM Y')); ?></td>
                                  ...
                                  <td>
                                    ...
                                    <a href="<?php echo e(URL('/Dashboard/prosesguruhapus/'.$item->id )); ?>"><span class="badge bg-danger" ><i class="bi bi-trash"></i></span></a>
                                  </td>
                                </tr>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ujicoba\web\resources\views/dashboard/gudang/daftarpembelianproduk.blade.php ENDPATH**/ ?>