                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="table_id" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    <?php $no=1;?>
                                    <?php $__currentLoopData = $gudangorders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($no++); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="event.preventDefault(); if (confirm('Anda yakin ingin menghapus?')) { document.getElementById('delete-form-<?php echo e($item->id); ?>').submit(); }"><span class="badge bg-danger"><i class="bi bi-trash"></i></span></a>

                                            <!-- Form untuk delete -->
                                            <form id="delete-form-<?php echo e($item->id); ?>" action="<?php echo e(URL('/Dashboard/destroy/pemesananproduk/'.$item->id )); ?>" method="POST" style="display: none;">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ujicoba\web\resources\views/dashboard/gudang/daftarpemesananproduk.blade.php ENDPATH**/ ?>